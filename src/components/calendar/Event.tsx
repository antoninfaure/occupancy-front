                    ...
                    <>
                        ...
                        ) : null}
                        {
                            schedule.rooms ? (
                                ...
                                <div
                                    className={`h-full col-span-3 ${borderStyle} overflow-x-auto border-l-[6px] border-solid pl-2 pr-3 bg-primary/5 text-primary dark:bg-accent/50 dark:text-primary rounded py-2 w-full hover:bg-primary/10 dark:hover:bg-accent/100 hover:shadow-md transition-all duration-200 ease-in-out`}
                                >
                                    <span>
                                        {schedule?.name}
                                    </span>
